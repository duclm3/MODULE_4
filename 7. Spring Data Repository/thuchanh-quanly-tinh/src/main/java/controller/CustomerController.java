...
public class CustomerController {
    ...
    public String createCustomer(@ModelAttribute("creatCustomerForm") Customer customer){
        Province province = provinceService.findById(customer.getProvince().getId()).get();
