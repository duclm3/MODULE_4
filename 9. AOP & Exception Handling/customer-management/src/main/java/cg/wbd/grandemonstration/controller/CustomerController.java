...
public class CustomerController {
    ...
    @GetMapping("/{id}")
    public ModelAndView showInformation(@PathVariable String id) throws Exception{
        try{
            ModelAndView modelAndView = new ModelAndView("/customers/info");
            Optional<Customer> customerOptional = customerService.findOne(Long.parseLong(id));
    ...
    public ModelAndView showInputNotFoundCustomer(){ return new ModelAndView("redirect:/customers"); }
